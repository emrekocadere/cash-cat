  ...
  <section className="bg-white/5 border border-white/10 rounded-3xl p-6 space-y-6">
    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
      <div>
        ...
        <p className="text-5xl font-bold text-white">{formatBalance(account.balance, account.currency)}</p>
      </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="p-4 rounded-2xl bg-slate-900/60 border border-white/10">
        ...
        <p className="text-lg font-semibold text-white mt-1">{account.currency}</p>
      </div>
      <div className="p-4 rounded-2xl bg-slate-900/60 border border-white/10">
    ...
    <div className="flex flex-wrap gap-3">
      <button className="px-6 py-3 bg-primary-600 hover:bg-primary-700 rounded-2xl text-white font-semibold">
        Add Transaction
      </button>
